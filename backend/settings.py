...
SECRET_KEY = 'django-insecure-xpr&we#*_dscpc-7=&n+ee1r9v$-abcz^zx*pqfk&eb_j)&ah_'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['web-production-91a45.up.railway.app']
...
EMAIL_PORT = 465  # GoDaddy uses 465 (SSL) or 587 (TLS)
EMAIL_USE_SSL = True  # Use SSL for port 465
# EMAIL_USE_TLS = True  # Use TLS for port 587 (pick one)
